...
import ai.tournesol.privacybolt.matrix.Notif
 ...
 * backgrounded — a foreground service, since Privacy Bolt can't use FCM/Google push
        ...
        fun ensureChannels(ctx: Context) {
            ...
            nm.createNotificationChannel(
                NotificationChannel(CH_STATUS, "Connection", NotificationManager.IMPORTANCE_LOW)
                    .apply { description = "Shows Privacy Bolt is connected over Tor" }
            )
            nm.createNotificationChannel(
